...
function scene:create( event )
	...
	local function selectAnswer10(event)
	...
	rec1:addEventListener("tap", selectAnswer10)

	local function selectAnswer11(event)
	...
	rec2:addEventListener("tap", selectAnswer11)

	local function selectAnswer12(event)
	...
	rec3:addEventListener("tap", selectAnswer12)
