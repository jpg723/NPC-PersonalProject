...
function scene:create( event )
	...
	local function timeAttack(event) 
		...
		if limit <= 0 then
			composer.setVariable("correct2", score)
			composer.gotoScene("d3")
		end
	end
	...
	local num4 = math.random(50)

	for i = 1, 2 do
		if num3 == num1 and num4 == num2 or num3 == num2 and num4 == num1 then
			num3 = math.random(100)
			num4 = math.random(50)
		end
	end
	local numX = display.newText(num3 , display.contentCenterX - 200, display.contentHeight*0.37, "font/123RF_하르방_R_TTF.ttf")
	numX:setFillColor(0)
	numX.size = 70
	...
	local numY = display.newText(num4 , display.contentCenterX, display.contentHeight*0.37, "font/123RF_하르방_R_TTF.ttf")
	numY:setFillColor(0)
	numY.size = 70
	...
	composer.setVariable("num3", num3)
	composer.setVariable("num4", num4)
end
